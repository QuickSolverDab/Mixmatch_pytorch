...
class VGG(nn.Module):
    ...
    def __init__(self, features, num_classes=1000, init_weights=True, dataset=None):
...
def vgg_bn(depth, **kwargs):
    model = VGG(make_layers(cfg['vgg'+str(depth)], batch_norm=True), **kwargs)
    return model
